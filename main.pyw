...
root.bind('<Enter>', lambda *args: root.attributes('-alpha', 1.0 if not closed else 0.4))
root.bind('<Leave>', lambda *args: root.attributes('-alpha', 0.6 if not closed else 0.4))
